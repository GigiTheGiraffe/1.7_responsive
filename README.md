...
#### Done! (*commit*: Changing body colors depending size of window or branch ex1)
...
#### Done! (*commit*: Display/hide elements or branch ex2)
...
#### Done! (*commit*: Font size adaptating to display or branch ex3)
...
#### Done! (*commit*: Rearrange or branch ex4)
